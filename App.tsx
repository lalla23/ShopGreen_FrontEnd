...
function App() {
  ...
  return (
    <Router>
      <div className="min-h-[100dvh] flex flex-col font-sans text-gray-900 bg-white dark:bg-gray-900 dark:text-gray-100 transition-colors duration-300">
        <Header 
          userRole={userRole} 
          userName={userName} 
          onLoginClick={() => {}}
...
function App() {
  ...
  return (
    <Router>
      <div className="h-[100dvh] w-full flex flex-col font-sans text-gray-900 bg-white dark:bg-gray-900 dark:text-gray-100 transition-colors duration-300 overflow-hidden relative">
        ...
        <main className="flex-1 overflow-y-auto overflow-x-hidden relative w-full pb-24 scroll-smooth">
          <Routes>
            <Route 
              path="/" 
              element={
